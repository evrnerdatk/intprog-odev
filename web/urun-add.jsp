        ...
        <div class="card card-signin my-5">
            <div class="card-body">
				<c:if test="${urun != null}">
					...
					<form action="UrunServlet/update" method="post">
                                         
                                                
				</c:if>
				<c:if test="${urun == null}">
					<form action="UrunServlet/insert" method="post">
				</c:if>
				...
				<c:if test="${urun != null}">
					<input type="hidden" name="id" value="<c:out value='${urun.id}' />" />
				</c:if>
                                    
                                        <div class="form-label-group">
                                    <input type="text"  id="inputkategori" placeholder="Kategori"   value="<c:out value='${urun.kategori}' />" class="form-control" name="kategori" required="required">
                                    <label for="inputkategori" style="cursor:text">Kategori</label> 
                                  
				</div>

				 <div class="form-label-group">
                                    <input type="text"  id="inputMarka" placeholder="Marka"   value="<c:out value='${urun.marka}' />" class="form-control" name="marka">
                                    <label for="inputMarka" style="cursor:text">Marka</label>
                                    
				</div>
				 <div class="form-label-group">
                                    <input type="text"  id="inputRenk" placeholder="Renk"  value="<c:out value='${urun.renk}' />" class="form-control"name="renk">
                                    <label for="inputRenk" style="cursor:text">Renk</label> 
				</div>
                                <div class="form-label-group">
                                    <input type="text"  id="inputstokAdedi" placeholder="stokAdedi"  value="<c:out value='${urun.stokAdedi}' />" class="form-control"name="stokAdedi">
                                    <label for="inputstokAdedi" style="cursor:text">stokAdedi</label>
                                </div>
