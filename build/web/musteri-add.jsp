    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
            <div class="card-body">
      <c:if test="${musteri != null}"> <!musteri null degerine eşit mi değil mi kontrolü yapıyoruz yani musteri nulla eşit değilse güncelleme işlemi yapıyoruz>
					<form action="MusteriServlet/update" method="post">
				</c:if>
				<c:if test="${musteri == null}">
					<form action="MusteriServlet/insert" method="post">
				</c:if>
				...
				<div class="form-label-group">
					<input type="text"  id="inputfirstName" placeholder="Ad"   value="<c:out value='${musteri.fName}' />" class="form-control"name="ad" required="required">
                                    <label for="inputfirstName" style="cursor:text">Ad</label>  <!update işlemi olduğu zaman otomatik olarak doldursun dite value komutu kullandık >
				</div>

				<div class="form-label-group">
					<input type="text"  id="inputlastName" placeholder="Soyad"   value="<c:out value='${musteri.lastName}' />" class="form-control"name="soyad">
                                    <label for="inputlastName" style="cursor:text">Soyad</label> 
				</div>
				<div class="form-label-group">
					<input type="text"  id="inputPhone" placeholder="Telefon"   value="<c:out value='${musteri.phone}' />" class="form-control"name="telefon">
                                    <label for="inputPhone" style="cursor:text">Telefon</label> 
				</div>
				<div class="form-label-group">
					<input type="text"  id="inputAdress" placeholder="Adres"   value="<c:out value='${musteri.adress}' />" class="form-control"name="adres">
                                    <label for="inputAdress" style="cursor:text">Adres</label> 
				</div>
